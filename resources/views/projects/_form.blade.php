...
<div class="row mb-2">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input required value="{{ old('nome', $project->nome ?? '') }}" class="form-control" type="text"
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input required value="{{ old('orcamento', $project->orcamento ?? '') }}" class="form-control"
                type="text" name="orcamento" id="orcamento" data-mask="#.##0,00" data-mask-reverse="true"
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input required
                ...
                placeholder="Digite a data de Final">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
