...
<div class="row mb-2">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input required value="{{ old('nome', $employee->nome ?? '') }}" class="form-control" type="text"
                name="nome" id="nome" maxlength="100" placeholder="Digite o nome">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="cpf">CPF</label>
            <input required value="{{ old('cpf', $employee->cpf ?? '') }}" class="form-control" type="text"
                name="cpf" id="cpf" data-mask="000.000.000-00" placeholder="Digite o cpf">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input required
                ...
                class="form-control" type="text" name="data_contratacao" id="data_contratacao" data-mask="00/00/0000"
...
<div class="row mb-2">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input required value="{{ old('cep', $employee->address->cep ?? '') }}" class="form-control" type="text"
                name="cep" id="cep" data-mask="00000-000" placeholder="Digite o CEP">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
